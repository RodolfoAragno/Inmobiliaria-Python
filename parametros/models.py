...
class Parametros(models.Model):
	porcentaje_propietario = models.DecimalField(max_digits=5, decimal_places=4)
	incremento_segundo_anio = models.DecimalField(max_digits=5, decimal_places=4)
	interes_diario = models.DecimalField(max_digits=7, decimal_places=6)
